...
$logo_urls = theme_mb2nl_logo_urls();
?>
<div class="main-logo" style="width:<?php echo theme_mb2nl_theme_setting($PAGE, 'logow','180'); ?>px;margin:<?php echo theme_mb2nl_theme_setting($PAGE, 'logom','15px 0 15px 0'); ?>;">
